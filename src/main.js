        ...
        <div className="App">
            ...
            {user ?
                <div className="todo-list box">
                    ...
                    }) : <h4>Add items to the docket to create your personalised todo-list.<br/><br/>[Nav -> Add item]</h4>}

                </div>
                :
                <div className="todo-list box">
                    <h4>User needs to authenticate for the application prior to using it.<br/><br/>[Nav -> Login]</h4>
                </div>}
